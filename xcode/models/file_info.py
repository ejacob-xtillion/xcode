"""
File information and caching models.
"""
import json
import time
...
class FileTreeCache:
    ...
    def build(self, skip_patterns: Optional[List[str]] = None) -> None:
        """
    ...
    def refresh_if_needed(self, skip_patterns: Optional[List[str]] = None) -> None:
