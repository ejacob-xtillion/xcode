...
def render_help_table(console: Console) -> None:
    ...
    table.add_row("/verbose", "Toggle verbose output (tool payloads, execution trace footer)")
    table.add_row("/trace", "Toggle post-task trace recap panel + execution trace footer")
